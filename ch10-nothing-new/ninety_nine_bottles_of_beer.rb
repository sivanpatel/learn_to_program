...
number_now=starting_number

while number_now >=2
	puts english_number(number_now) + ' Bottles of beer on the wall' + english_number(number_now) + ' Bottles of beer!'
	number_now=number_now - 1
	puts 'Take one down, pass it around ' english_number(number_now) + ' bottles of beer on the wall'
end
